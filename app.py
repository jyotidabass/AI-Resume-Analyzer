...
async def resume_analysis(file_path):
    ...
    async def review1_task():
        ...
        return await asyncio.get_event_loop().run_in_executor(
            None, generate_response, [check0], generation_config
        )
    ...
    async def review2_task():
        ...
        return await asyncio.get_event_loop().run_in_executor(
            None, generate_response, [check1], generation_config
        )

    info_task = asyncio.create_task(extract_info_task())
    r1_task = asyncio.create_task(review1_task())
    r2_task = asyncio.create_task(review2_task())

    dictionary, review0, review1 = await asyncio.gather(info_task, r1_task, r2_task)
    print(dictionary)
...
def footer():
    st.markdown(
        ...
        <div class="footer">
            Built with 💙 by <a href="https://www.linkedin.com/in/jyoti-dabass-ph-d-2b747083/" target="_blank">Jyoti Dabass</a>.  
            Let's connect on <a href="https://github.com/jyotidabass" target="_blank">GitHub</a> and 
            <a href="https://www.linkedin.com/in/jyoti-dabass-ph-d-2b747083/" target="_blank">LinkedIn</a>.
        </div>
        """,
